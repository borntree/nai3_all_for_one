...
def main():
    ...
    parse.add_argument("-f", "--file", type=str, default="./5_joint_output",
                       help="image file path or directory")
    parse.add_argument("-m", "--mark", type=str, default="poimiku", help="watermark content")
    ...
    parse.add_argument("-s", "--space", default=700, type=int,
    ...
    parse.add_argument("--font-height-crop", default="1.2", type=str,
                       ...
                       '''))
    parse.add_argument("--size", default=150, type=int,
