...
def add_mark(imagePath, mark, args):
    ...
    image = mark(im)
    name = "0" + os.path.basename(imagePath)
    if image:
...
def main():
    ...
    parse.add_argument("-f", "--file", type=str, default="./4_generate_output", 
                       help="image file path or directory")
    parse.add_argument("-m", "--mark", type=str, default="poimiku", help="watermark content") #水印
    parse.add_argument("-o", "--out", default="./6_marker",
                       help="image output directory, default is ./output")
    parse.add_argument("-c", "--color", default="#363433", type=str,
                       help="text color like '#363433', default is #fbc82f")
    parse.add_argument("-s", "--space", default=900, type=int,
    ...
    parse.add_argument("--font-family", default="./font/Inkfree.ttf", type=str,
    ...
    parse.add_argument("--font-height-crop", default="1.2", type=str,
                       ...
                       '''))
    parse.add_argument("--size", default=125, type=int,
                       help="font size of text, default is 50")
    parse.add_argument("--opacity", default=0.5, type=float,
                       help="opacity of watermarks, default is 0.15")
    parse.add_argument("--quality", default=300, type=int,
